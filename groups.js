...
function addIdleGroup(IdleGroup){
    ...
    $('.g-join').click(function(){
        ...
        $.post("https://serenity-phone/j_group", JSON.stringify({
            gId: gid,
            members: members
        }))
...
$('.b-g-ready').click(function(){
    ...
    if (ready == 0){
        ...
        $.post("https://serenity-phone/group_status", JSON.stringify({
            status: true,
            gId: gId
        }))
    }else{
...
$('#create-Group').click(function(){
    ...
    $.post("https://serenity-phone/c_group", JSON.stringify({}))
    complateInputJustGreen();
        setTimeout(() => {
            // $.post("https://serenity-phone/btnDebt", JSON.stringify({}))
...
$('.g-disband').click(function(){
    ...
    $.post("https://serenity-phone/leave_group", JSON.stringify({
        gid: gId
    }))
    complateInputJustGreen();
        setTimeout(() => {
