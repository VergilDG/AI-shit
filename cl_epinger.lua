...
RegisterNUICallback("serenity-ui:pingSend", function(data, cb)
...
RegisterNUICallback("serenity-ui:pingAccept", function(data, cb)
...
RegisterNUICallback("serenity-ui:pingReject", function(data, cb)
