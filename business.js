...
function manageGroups(id){
    $.post('http://serenity-phone/manageGroup', JSON.stringify({
        GroupID: id
    }));
}
...
$('#group-manage-fire-accept').click(function(e){
    ...
    setTimeout(() => {
        $.post('http://serenity-phone/fireEmployee', JSON.stringify({
...
$("#rank-submit-input").click(function (e) {
    ...
    complateInputJustGreen();
    setTimeout(() => {
        $.post('http://serenity-phone/addEmployee', JSON.stringify({
            business: business_id,
            rank: rank,
            state_id: state_id
        }));
...
$("#rankSet-submit-input").click(function (e) {
    ...
    complateInputJustGreen();
    setTimeout(() => {
        $.post('http://serenity-phone/editEmployee', JSON.stringify({
            business: business_id,
            rank: rank,
            state_id: state_id
        }));
...
$("#paycheck-submit-input").click(function (e) {
    ...
    complateInputJustGreen();
    setTimeout(() => {
        $.post('http://serenity-phone/payCheckEmployee', JSON.stringify({
            business: business_id,
            amount: amount,
            state_id: state_id
        }));
...
$("#add-cash-submit-input").click(function(e){
    ...
    $('.group-manage-add-cash').hide()
    complateInputJustGreen();
    $.post('http://serenity-phone/addCashBank', JSON.stringify({
            bid: bId,
            amount: amount,
    }));
    setTimeout(() => {
